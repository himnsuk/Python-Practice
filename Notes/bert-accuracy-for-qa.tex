...
\begin{enumerate}
   \item 
      ...
      Where:
      \begin{itemize}
         \item [-]$(N)$ is the total number of questions in the dataset.
         \item [-]$(\mathbf{1}(\cdot))$ is an indicator function that equals 1 if the condition is true (i.e., the predicted start and end positions match the true start and end positions), and 0 otherwise.
      \end{itemize}
